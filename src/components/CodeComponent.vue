...
const MIN_CODE_WIDTH = 0.4;
const MAX_CODE_WIDTH = 0.7;
const MIN_COMPILED_WIDTH = 0.15; // Reduced minimum width for compiled section
const MAX_COMPILED_WIDTH = 0.3; // Reduced maximum width for compiled section
const INITIAL_CODE_WIDTH = 1;
const INITIAL_PARAMS_WIDTH = 0.25; // Increased initial width for params section
const INITIAL_COMPILED_WIDTH = 0.25; // Reduced initial width for compiled section
